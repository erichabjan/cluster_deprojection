...
These xy conditioning images paired with the cluster-member galaxy dynamics allows for the non-parameteric mass distribution to be inferred. The inferred total mass enclosed within this 10 Mpc<sup>3</sup> cube is compared with the true enclosed cube mass: 
