...
from conditional_diffusion_3d_model_spatial import ConditionalUNet3D, DiffusionModelConfig
from train_conditional_diffusion import preload_hdf5_to_memory, sample_ddpm

suffix = '_64cube_v3_vzdisp'
...
seeds = np.arange(0, 25, dtype=np.int32)
...
save_path = os.path.join(out_dir, f"sampled_cubes_validx_{test_idx:04d}{suffix}.npz")
